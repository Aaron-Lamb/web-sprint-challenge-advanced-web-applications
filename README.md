...
Number one, don't use your personal computer as a host server. Password protecting is typically the first step, and the list of usernames and passwords would be kept in another secure server. That's all I can remember off the top of my head.
